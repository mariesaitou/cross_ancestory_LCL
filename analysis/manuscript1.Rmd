---
title: "For the manuscript (1) Data Preparation"
author: "Marie Saitou"
date: "7/1/2021"
output: html_document
---

![data preparation](assets/PR.7.2021/Slide2.png)
...
## Generate "sample - gene expression" matrix file
```{r, eval = FALSE}
...
write.table(txi$counts,sep="\t", file = "EUR.counts.tsv")
write.table(txi$abundance,sep="\t", file = "EUR.CPM.tsv")
```
...
![fastQTL](assets/PR.7.2021/Slide3.png)
